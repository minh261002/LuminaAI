                ...
                <div>
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-5 items-center justify-between'>
                        <div>
                            ...
                            <p className='text-center text-muted-foreground mt-2 lg:text-left'>
                            ...
                            {tabs.map((tab) => {
                                ...
                                return (
                                    <TabsTrigger
                                        key={tab.value}
                                        value={tab.value}
                                        className='flex items-center gap-2 rounded-xl data-[state=active]:bg-white/[0.15] data-[state=active]:backdrop-blur-xl data-[state=active]:border data-[state=active]:border-white/[0.02] transition-all duration-200 text-xs sm:text-sm'
                                    >
